        ...
        <div className="mx-auto max-w-7xl px-5 md:px-8 grid gap-12 md:grid-cols-2 items-center pb-20 md:pb-28">
          <div>
            ...
            <div className="mt-7 flex flex-col sm:flex-row gap-3">
              ...
              <a href="tel:+18005550199" className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-primary px-6 py-3.5 text-base font-semibold text-primary hover:bg-primary hover:text-primary-foreground transition-colors">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-5 md:px-8 py-20 md:py-28 text-center text-primary-foreground">
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-3">
            ...
            <a href="tel:+18005550199" className="inline-flex items-center justify-center gap-2 rounded-full bg-white/10 backdrop-blur border border-white/20 px-7 py-4 text-base font-semibold hover:bg-white/20 transition">
              <Phone className="h-4 w-4" /> Call Now
            </a>
          </div>
        </div>
      ...
      <section id="contact" className="section-pad">
        <div className="mx-auto max-w-7xl px-5 md:px-8 grid gap-12 lg:grid-cols-2 items-start">
          <div>
            ...
            <a href="https://wa.me/18005550199" target="_blank" rel="noreferrer" className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#25D366] text-white px-5 py-3 text-sm font-semibold hover:opacity-90 transition">
