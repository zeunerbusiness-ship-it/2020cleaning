  ...
  return (
    <footer className="bg-primary text-primary-foreground">
      <div className="mx-auto max-w-7xl px-5 md:px-8 py-16 grid gap-12 md:grid-cols-3">
        <div>
          ...
          <p className="mt-4 text-sm text-primary-foreground/70 max-w-xs">
            Trusted house cleaning services in Orlando and surrounding areas.
          </p>
      ...
      <div className="border-t border-white/10 pb-24 md:pb-0">
        <div className="mx-auto max-w-7xl px-5 md:px-8 py-6 text-xs text-primary-foreground/60 flex flex-col md:flex-row justify-center text-center gap-2">
